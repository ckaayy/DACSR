...
################
    parser.add_argument('--experiment_dir', type=str, default='experiments_dataset%s_sample%s'%(dataset_default,sample_type_default))
   ...
   ###################################################################
    space = {'max_len_list':[20],
             ...
             'drop_rate_list': [0.1],#[0.1],
             'drop_rate_emb_list':[0.5,0.3,0.4],#[0.4],
