...
class ToyDataset(AbstractDataset):
    ...
    def all_raw_file_names(cls):
        return ['ratings_Toys.csv',
		]

    def load_ratings_df(self):
        folder_path = self._get_rawdata_folder_path()
        file_path = folder_path.joinpath('ratings_Toys.csv')
    ...
    #         # file_path = folder_path.joinpath('toy_test_new_user.csv')
    #         # df_target.to_csv(file_path, index=False, header=False)
    #         # file_path = folder_path.joinpath('toy_train.csv')
