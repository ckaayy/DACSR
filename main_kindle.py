...
################    
    ...
    parser.add_argument('--train_target_batch_size', type=int, default=200)
    parser.add_argument('--train_source_batch_size', type=int, default=200)
    parser.add_argument('--train_combine_batch_size', type=int, default=200)
...
################
    ...
    parser.add_argument("--static_weight",type=float,default=0.0,help="Weight on the static (SimCLR‐style) loss term")
    parser.add_argument('--warmup_epochs',type=int,default=40,help='Number of epochs over which static_weight decays from 1.0 to 0.0')
...
################
    ...
    for ne_seed in test_negative_sampling_seed_list:
        ...
        ################m
        mask_list = [0.5]#[0.4, 0.5, 0.6, 0.7]
        alpha_sst_list = [0.2] #[0, 0.01, 0.02, 0.05, 0.1]
        beta_t_list = [0.03] #[0.01, 0.02, 0.05, 0.1]
        alpha_list = [0.1] #[0.01, 0.02, 0.05, 0.1]
        beta_st_list = [0.07] #[0, 0.01, 0.04, 0.05]#[0,0.04]  
        val_best_before = 0
